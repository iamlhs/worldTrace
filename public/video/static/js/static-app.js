...
document.addEventListener("DOMContentLoaded", () => {
    ...
    videoInput.addEventListener("change", () => {
        ...
        selectedFile.textContent = file ? `已选择：${file.name}` : "支持 MP4、AVI、MOV、MKV；视频将在本地由深度学习模型分析处理。";
        statusLine.textContent = file ? "视频已选择，点击下方按钮启动深度学习实时分析。" : "";
    ...
    showResultButton.addEventListener("click", () => {
        ...
        setTimeout(() => {
            ...
            showResultButton.querySelector('span').textContent = '深度学习实时分析';
